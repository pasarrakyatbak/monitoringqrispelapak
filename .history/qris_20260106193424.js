...
function renderData(data) {
    ...
    container.innerHTML = data.map(d => `
        <div class="pelapak-item">
            <span class="p-name">${d.no}. ${d.nama}</span>
            ...
            <label class="label-hint">Status Pembayaran QRIS:</label>
            <select class="input-big" id="status-${d.no}">
                <option value="Belum" ${d.statusQRIS === 'Belum' ? 'selected' : ''}>❌ BELUM ADA</option>
                <option value="Sudah" ${d.statusQRIS === 'Sudah' ? 'selected' : ''}>✅ SUDAH ADA</option>
            </select>
